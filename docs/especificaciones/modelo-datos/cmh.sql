...
;
DROP TRIGGER TRG_BANCO_ID_BANCO
;


DROP SEQUENCE SEQ_BANCO_ID_BANCO
;


DROP TABLE BANCO CASCADE CONSTRAINTS
;
DROP TRIGGER TRG_BLOQUE_ID_BLOQUE
;


DROP SEQUENCE SEQ_BLOQUE_ID_BLOQUE
;
...
;
DROP TRIGGER TRG_CUEN_BANCARIA_ID_CUEN_BANC
;


DROP SEQUENCE SEQ_CUEN_BANCARIA_ID_CUEN_BANC
;


DROP TABLE CUEN_BANCARIA CASCADE CONSTRAINTS
;
...
;
DROP TRIGGER TRG_DIA_SEM_ID_DIA
;


DROP SEQUENCE SEQ_DIA_SEM_ID_DIA
;


DROP TABLE DIA_SEM CASCADE CONSTRAINTS
;
...
;
DROP TRIGGER TRG_HORARIO_ID_HORARIO
;


DROP SEQUENCE SEQ_HORARIO_ID_HORARIO
;
...
;
DROP TRIGGER TRG_LOGPAGOHONORA_IDLOGPAGOHON
;


DROP SEQUENCE SEQ_LOGPAGOHONORA_IDLOGPAGOHON
;


DROP TABLE LOGPAGOHONORARIO CASCADE CONSTRAINTS
;
...
;
DROP TRIGGER TRG_TIPO_C_BANCAR_ID_TIPO_C_BA
;


DROP SEQUENCE SEQ_TIPO_C_BANCAR_ID_TIPO_C_BA
;


DROP TABLE TIPO_C_BANCARIA CASCADE CONSTRAINTS
;
...
;
DROP TRIGGER TRG_TIPO_FICHA_ID_TIPO_FICHA
;


DROP SEQUENCE SEQ_TIPO_FICHA_ID_TIPO_FICHA
;


DROP TABLE TIPO_FICHA CASCADE CONSTRAINTS
;
...
ALTER TABLE ATENCION_AGEN ADD CONSTRAINT FK_ATENCION_AGEN_ORDEN_ANALIS 

...
ALTER TABLE ATENCION_AGEN ADD CONSTRAINT FK_ESTADO_ATEN_ATENCION_AGEN 
	FOREIGN KEY (ID_ESTADO_ATENCION) REFERENCES ESTADO_ATEN (ID_ESTADO_ATENCION) ON DELETE CASCADE
;
...
ALTER TABLE PERS_MEDICO ADD CONSTRAINT FK_PERS_MEDICO_CUEN_BANCARIA 
	FOREIGN KEY (ID_TURNO) REFERENCES CUEN_BANCARIA (ID_CUEN_BANCARIA) ON DELETE CASCADE
;
...
ALTER TABLE RES_ATENCION ADD CONSTRAINT FK_ATENCION_AGEN_RES_ATENCION 
	FOREIGN KEY (ID_ATENCION_AGENDADA) REFERENCES ATENCION_AGEN (ID_ATENCION_AGEN) ON DELETE CASCADE
;

<%-- 
    ...
    Created on : 11-nov-2016, 13:37:35
    Author     : dev
--%>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="panel panel-default text-center">
                        ...
                        <div class="panel-body">
                            <h4>Médico especialista</h4>
                            <p>Para problemas específicos</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="panel panel-default text-center">
                        ...
                        <div class="panel-body">
                            <h4>Exámenes de imagenología</h4>
                            <p>Exámenes de radiografías</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="panel panel-default text-center">
                        ...
                        <div class="panel-body">
                            ...
                            <p>Exámenes de sangre o fluídos</p>
                        </div>
                    </div>
                </div>
            </div>

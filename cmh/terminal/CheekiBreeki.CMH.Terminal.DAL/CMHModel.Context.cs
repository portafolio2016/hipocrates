...
namespace CheekiBreeki.CMH.Terminal.DAL
{
    ...
    public partial class CMHConnectionString : DbContext
    {
        public CMHConnectionString()
            : base("name=CMHConnectionString")
        {
        }
        ...
        public virtual DbSet<ATENCION_AGENDADA> ATENCION_AGENDADA { get; set; }
